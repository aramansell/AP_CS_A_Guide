...
One source of truth for:
  - the day-by-day pacing (Sept 2026 - June 2027, A days only)
  - CED (Fall 2025) topic coverage mapping
  - the dashboard lesson lists and pace.html
...
EXAM_DATE = date(2027, 5, 12)
EXAM_TIME = "12:00 PM (Session 2)"
...
# kind: launch | lesson | test | frq | mock | clinic | eve | season2 | capstone
# ced: CED topic numbers covered (Fall 2025 CED)
SEQUENCE = [
    # ---------------- PHASE 1: Using Objects and Methods (CED Unit 1, 15-25%) ----------------
    dict(d="2026-08-31", kind="launch",   group="1.1", phase=1, ced=["1.1", "1.2"],
    ...
    dict(d="2026-09-02", kind="lesson",  group="1.2", phase=1, ced=["1.2", "1.3", "1.4"],
         title="Printing, Concatenation, StatBlock", lessons=["1.1b", "1.1c", "1.2a"]),
    dict(d="2026-09-08", kind="lesson",  group="1.3", phase=1, ced=["1.3", "1.11"],
         title="Math.random() Deep Dive", lessons=["1.2b", "1.2c", "1.3a"]),
    dict(d="2026-09-10", kind="lesson",  group="1.4", phase=1, ced=["1.3", "1.4"],
         title="Slot Machine Build", lessons=["1.3b", "1.3c", "1.4a", "1.4b"]),
    dict(d="2026-09-14", kind="lesson",  group="1.5", phase=1, ced=["1.3", "1.4"],
         title="Tip Calculator Build", lessons=["1.4c", "1.5a", "1.5b"]),
    dict(d="2026-09-16", kind="lesson",  group="1.6", phase=1, ced=["1.3", "1.4", "1.15"],
         title="Bill Splitter & RPG Gold", lessons=["1.5c", "1.6a", "1.6b", "1.6c"]),
    dict(d="2026-09-18", kind="lesson",  group="1.7", phase=1, ced=["1.9", "1.10"],
         title="Dice Roller RPG Build", lessons=["1.7a", "1.7b", "1.7c"]),
    dict(d="2026-09-23", kind="lesson",  group="1.8", phase=1, ced=["1.5", "1.6"],
    ...
    dict(d="2026-09-25", kind="lesson",  group="2.1", phase=1, ced=["1.12", "1.13", "1.14"],
         title="Objects & Classes, RPG Character Creator", lessons=["2.1a", "2.1b", "2.1c"]),
    dict(d="2026-09-29", kind="lesson",  group="2.2", phase=1, ced=["1.14", "1.15"],
         title="String Exploration & Parser", lessons=["2.2a", "2.2b", "2.2c"]),
    dict(d="2026-10-01", kind="lesson",  group="2.3", phase=1, ced=["1.4", "1.14"],
         title="Scanner Input & Combat Dialogue", lessons=["2.3a", "2.3b", "2.3c"]),
    dict(d="2026-10-05", kind="lesson",  group="2.4", phase=1, ced=["1.4", "1.14"],
         title="Scanner Discovery & Character Input", lessons=["2.4a", "2.4b", "2.4c"]),
    dict(d="2026-10-07", kind="lesson",  group="2.5", phase=1, ced=["1.10", "1.11"],
         title="The Math Class: Damage & Distance", lessons=["2.5a", "2.5b", "2.5c"]),
    dict(d="2026-10-09", kind="lesson",  group="2.6", phase=1, ced=["4.7"],
         title="Wrapper Classes & Stat Serializer", lessons=["2.6a", "2.6b", "2.6c"]),
    dict(d="2026-10-14", kind="lesson",  group="2.7", phase=1, ced=["1.12", "1.13", "1.14", "1.15"],
         title="Character Creator RPG Build", lessons=["2.7a", "2.7b", "2.7c"]),
    dict(d="2026-10-16", kind="lesson",  group="2.8", phase=1, ced=["1.7", "1.8", "1.9"],
    ...
    dict(d="2026-10-20", kind="lesson",  group="2.9", phase=1, ced=["1.15"],
    ...
    dict(d="2026-10-22", kind="test",    group="T1", phase=1, ced=[],
    ...
    dict(d="2026-10-26", kind="clinic",  group="R1", phase=2, ced=[],
    ...
    dict(d="2027-01-05", kind="frq",     group="E1", phase=3, ced=["2.9"],
    ...
    dict(d="2027-01-07", kind="lesson",  group="5.1", phase=3, ced=["3.3", "3.4"],
         title="Anatomy of a Class & Your First Class", lessons=["5.1a", "5.1b", "5.1c"]),
    dict(d="2027-01-11", kind="lesson",  group="5.2", phase=3, ced=["3.4"],
         title="Constructors & Enemy Factory", lessons=["5.2a", "5.2b", "5.2c"]),
    dict(d="2027-01-13", kind="lesson",  group="5.3", phase=3, ced=["3.5", "3.8"],
         title="Accessors, Mutators & Validation", lessons=["5.3a", "5.3b", "5.3c"]),
    dict(d="2027-01-15", kind="lesson",  group="5.4", phase=3, ced=["3.5", "3.6", "3.7", "3.8", "3.9"],
         title="Methods, static, this, Card & BankAccount", lessons=["5.4a", "5.4b", "5.4c"]),
    dict(d="2027-01-20", kind="lesson",  group="5.5", phase=3, ced=["3.1", "3.5"],
         title="Player & Monster RPG Build", lessons=["5.5a", "5.5b", "5.5c"]),
    dict(d="2027-01-22", kind="lesson",  group="5.6", phase=3, ced=["3.1", "3.2"],
    ...
    dict(d="2027-01-27", kind="test",    group="T3", phase=3, ced=[],
    ...
    dict(d="2027-01-29", kind="frq",     group="E2", phase=3, ced=["3.1", "3.2"],
    ...
    dict(d="2027-02-02", kind="lesson",  group="6.1", phase=4, ced=["4.3"],
         title="Array Basics & RPG Inventory", lessons=["6.1a", "6.1b", "6.1c"]),
    dict(d="2027-02-04", kind="lesson",  group="6.2", phase=4, ced=["4.4"],
         title="Array Traversal & Party Manager", lessons=["6.2a", "6.2b", "6.2c"]),
    dict(d="2027-02-08", kind="lesson",  group="6.3", phase=4, ced=["4.5", "4.14"],
         title="Array Algorithms: Search & Insert", lessons=["6.3a", "6.3b", "6.3c"]),
    dict(d="2027-02-10", kind="lesson",  group="6.4", phase=4, ced=["4.4", "4.5"],
         title="Arrays of Objects & Card Deck", lessons=["6.4a", "6.4b", "6.4c"]),
    dict(d="2027-02-12", kind="lesson",  group="6.5", phase=4, ced=["4.3", "4.4", "4.5"],
         title="Item Class & FixedInventory RPG Build", lessons=["6.5a", "6.5b", "6.5c"]),
    dict(d="2027-02-23", kind="lesson",  group="6.6", phase=4, ced=["4.1", "4.2"],
    ...
    dict(d="2027-02-25", kind="lesson",  group="7.1", phase=4, ced=["4.8"],
         title="ArrayList Basics & Quest Log", lessons=["7.1a", "7.1b", "7.1c"]),
    dict(d="2027-03-01", kind="lesson",  group="7.2", phase=4, ced=["4.9"],
         title="ArrayList Traversal & Enemy Horde", lessons=["7.2a", "7.2b", "7.2c"]),
    dict(d="2027-03-03", kind="lesson",  group="7.3", phase=4, ced=["4.14", "4.15"],
         title="Searching & Sorting", lessons=["7.3a", "7.3b", "7.3c"]),
    dict(d="2027-03-05", kind="lesson",  group="7.4", phase=4, ced=["4.10"],
         title="Dynamic Inventory RPG Build", lessons=["7.4a", "7.4b", "7.4c"]),
    dict(d="2027-03-09", kind="lesson",  group="7.5", phase=4, ced=["4.10"],
    ...
    dict(d="2027-03-11", kind="lesson",  group="7.6", phase=4, ced=["4.6", "4.10"],
         title="Reading Files: monsters.txt & Save Data", lessons=["7.6a", "7.6b"], new=True,
         note="New CED topic: using text files (File + Scanner)."),
    dict(d="2027-03-15", kind="frq",     group="E3", phase=4, ced=["4.8", "4.9", "4.10"],
    ...
    dict(d="2027-04-26", kind="lesson",  group="10.6", phase=4, ced=["4.17"],
    ...
    # ---------------- SPRINT ----------------
    dict(d="2027-04-28", kind="mock",    group="M1", phase=5, ced=[],
    ...
    dict(d="2027-04-30", kind="mock",    group="M2", phase=5, ced=[],
         title="Mock Exam: Free Response (4 questions, 90 min)", lessons=[],
         note="Full Section II simulation."),
    dict(d="2027-05-04", kind="clinic",  group="C1", phase=5, ced=[],
    ...
    dict(d="2027-05-12", kind="exam",    group="EX", phase=5, ced=[],
    ...
    dict(d="2027-05-14", kind="season2", group="9.1", phase=6, ced=[],
...
PHASES = {
    1: dict(name="Phase 1: Using Objects and Methods", ced="CED Unit 1", weight="15-25% of the exam",
            span="Aug 31 - Oct 22", old="Old Units 1 + 2", color="discovery"),
    2: dict(name="Phase 2: Selection and Iteration", ced="CED Unit 2", weight="25-35% of the exam",
            span="Oct 26 - Dec 22", old="Old Units 3 + 4", color="basic-app"),
    3: dict(name="Phase 3: Class Creation", ced="CED Unit 3", weight="10-18% of the exam",
            span="Jan 5 - Jan 29", old="Old Unit 5", color="expand-app"),
    4: dict(name="Phase 4: Data Collections", ced="CED Unit 4", weight="30-40% of the exam",
            span="Feb 2 - Apr 26", old="Old Units 6, 7, 8, 10", color="rpg"),
    5: dict(name="Sprint: Exam Prep", ced="", weight="The exam is May 12, 2027",
            span="Apr 28 - May 10", old="Mock exam + clinics", color="assessment"),
    6: dict(name="Season 2: The Engine Room", ced="Post-exam", weight="Beyond the exam, for the love of the game",
...
if __name__ == "__main__":
    ...
    for entry in SEQUENCE:
        covered.update(entry["ced"])
    missing = set(CED_TOPICS) - covered
    print(f"A-days listed: {len(A_DAYS)}")
    print(f"Sequence entries: {len(SEQUENCE)}")
    print(f"CED topics covered: {len(covered)}/{len(CED_TOPICS)}")
    if missing:
        print("MISSING:", sorted(missing))
    else:
        print("All CED topics covered.")
    # date sanity
    seq_days = [e["d"] for e in SEQUENCE]
    assert len(seq_days) == len(set(seq_days)), "duplicate dates"
    assert all(d in A_DAYS for d in seq_days), "sequence date not an A day"
    print("Date sanity checks passed.")